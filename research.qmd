...
- **Broad Scale:** Total bite rates (bites per 30 min) of obligate corallivorous fishes were directly and positively influenced by species richness and feeding behaviour (duration and intensity). Predation risk and structural complexity showed no significant direct or indirect negative effects.

![Study sites across coral reefs in northeast Australia (Hsu et al., 2026).](images/Map_broad.png){fig-align="center" width="75%"}
...
![Study sites within One Tree Reef Lagoon, southern Great Barrier Reef, Australia (Hsu et al., in review).](images/Map_OTI.png){fig-align="center" width="75%"}
...
These short-term sub-lethal impacts could elevate coral susceptibility to environmental stress.

![Graphical abstract from Hsu et al. (2026).](images/Tank_Abs.png){width="100%" fig-align="center"}
...
![Graphical abstarct from Sommer et al. (2025).](images/Sommer_Abs.jpg){width="60%" fig-align="center"}
...
- **Key Takeaway:** Survey methodologies should be selected based on specific ecological questions and target spatial scales rather than defaulted to combination approaches.

![Graphical abstract from Hsu et al. (2023).](images/eDNA_Abs.jpg){width="100%" fig-align="center"}
...
Investigated the organismal traits and unique algal symbiont associations of two octocoral species inhabiting a high-latitude, marginal coral community in northern Taiwan.

![Study octocoral species in Hsu et al. (2020).](images/Litophyton_Stereonephthya.png){width="100%" fig-align="center"}
